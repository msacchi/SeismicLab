function [DATA_f] = mssa_3d_interp(T,DATA,dt,P,flow,fhigh,meth);
% mssa_3d_interp: applies mssa to interpolated 3D data
%
%  [DATA_f,] = mssa_3d(DATA,dt,P,flow,fhigh,meth);
%
%  IN   DATA:    The 3D array data, columns are traces DATA(t,x,y)
%       T:       Spatial sampling Operator (2D in this case)
